...
function SearchLead() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8081/lead/${id}`)
      .then((res) => {
        console.log(res);
        const formattedData = res.data.map((lead) => ({
          log_id: lead.log_id,
                ...
                <div className="fields">
                  <div className="input-field">
                    ...
                    <input
                      type="text"
                      value={
                        filteredData.length > 0 ? filteredData[0].lead_name : ""
                      }
                  ...
                  <div className="input-field">
                    ...
                    <input
                      type="text"
                      value={
                        filteredData.length > 0 ? filteredData[0].address : ""
                      }
                      placeholder="Enter Name"
                      required
                      // onChange={(e) => {
                  ...
                  <div className="input-field">
                    ...
                    <input
                      ...
                      value={
                        filteredData.length > 0 &&
                        filteredData[0].follow_up_date !== "1899-11-30" &&
                        filteredData[0].follow_up_date !== ""
                          ? filteredData[0].follow_up_date
                          : "N/A"
                      }
                      required
                  ...
                  <div className="input-field">
                    ...
                    <input
                      ...
                      value={
                        filteredData.length > 0
                          ? filteredData[0].sales_person_name
                          : ""
                      }
                      required
                      // onChange={(e) => {
                  ...
                  <div className="input-field">
                    ...
                    <input
                      ...
                      required
                      value={
                        filteredData.length > 0 ? filteredData[0].note : ""
                      }
                      // onChange={(e) => {
                      //   setValues({ ...values, note: e.target.value });
                      // }}
